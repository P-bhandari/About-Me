      ...
      {!started ? (
        ...
        <>
          ...
          <div className="game-status">
            <span className="status-dot" /> Choose a destination{' '}
          ...
          <div className="destination-menu" aria-label="World destinations">
            {atlasDestinations.map((destination, index) => {
              ...
              return (
                <button
                  key={href}
                  className={`destination destination-${index + 1}`}
    ...
    <main>
      ...
      <section className="atlas-hero" id="top" aria-labelledby="hero-title">
        <nav className="topbar" aria-label="Primary navigation">
          ...
          <a className="signal-link" href={`mailto:${profile.email}`}>
      ...
      <section className="content-section profile-section" id="about">
        ...
        <div className="experience-list">
          {experience.map((item, index) => (
            <article className="experience-row" key={item.years}>
                ...
                <article className="project-card" key={project.id}>
                  ...
                  <div className="project-copy">
                    <div className="card-meta">
                      ...
                      <span>
                        BUILD / {String(project.sortOrder).padStart(2, '0')}
                      </span>
                    </div>
                    <h3>{project.title}</h3>
                    <p>{project.summary}</p>
